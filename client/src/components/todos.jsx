...
const Todos = () => {
    ...
    const search = () => {
        setFilteredData(todosData.filter((todo) => {
           if( todo.title.toLowerCase().includes(inputSearch.current.value.toLowerCase())){
            return true
           }
    ...
    return (<>
        ...
        <div class="grid">
        {filteredData? filteredData.map((todo) => { return <Todo todo={todo} updateComplete={updateComplete} updateTodo={updateTodo} deleteTodo={deleteTodo} /> }) : ( todosData ? todosData.map((todo) => { return <Todo todo={todo} updateComplete={updateComplete} updateTodo={updateTodo} deleteTodo={deleteTodo} /> }) : <></>)}
